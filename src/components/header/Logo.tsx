...
const Logo = () => {
  return (
    <div className="my-2 w-16 aspect-square">
      <Link href="/">
        <svg
          id="Layer_2"
          data-name="Layer 2"
        ...
        >
          ...
          <motion.path
            ...
            d="m144.53,741.52L503.3,45.43m307.37,689.64L445.54,32.06m-234.9,792.85L503.46,262.07m-49.75,1.77l289.02,558.53"
          />
          <path
            id="white2"
            className="fill-white"
            d="m508.45,310.89l-29.83-57.53-30.37,57.53-24.62-37.44,57.18-26.1,52.08,26.9-24.43,36.65"
          />
          <motion.path
            id="G"
            initial={{ opacity: 0, pathLength: 0 }}
