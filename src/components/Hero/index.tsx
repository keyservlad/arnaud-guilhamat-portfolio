      ...
      <div className="mx-auto flex max-w-[940px] flex-row items-center justify-center">
        <div className="flex flex-col justify-center pl-6 pr-14">
          ...
          <div className="flex flex-row gap-4">
            <button className="relative z-10 my-[10px] flex cursor-pointer self-start rounded-lg border border-black bg-black px-10 py-4 font-bold text-white hover:border-slate-200 hover:bg-white hover:text-black ">
              Contact Me
              <svg
            ...
            <button className="hover:shadow-custom flex cursor-pointer items-center self-center rounded-lg border border-slate-200 bg-white px-10 py-4 font-bold text-black hover:border-black hover:bg-black hover:text-white">
              Download CV
              <svg
                xmlns="http://www.w3.org/2000/svg"
                aria-hidden="true"
