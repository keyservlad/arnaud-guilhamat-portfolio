    ...
    <div className="w-full">
      ...
      >
        <Image
          ...
          className="absolute left-0 top-0 -z-10 h-full w-full px-3"
        />
        <p className="mx-auto mb-[10px] mt-0 max-w-[493px] text-center">
          ...
          respect the Kanban processes and rituals implemented in our company as
          well as working in complete autonomy and responsibility throughout his
          missions.
        </p>
